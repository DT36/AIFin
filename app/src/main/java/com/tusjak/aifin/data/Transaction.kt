...
data class Transaction(
    ...
    val title   : String = "",          // Názov transakcie (napr. "Nákup potravín")
    val amount  : Double = 0.0,         // Suma transakcie
    val date    : Date = Date(),        // Dátum transakcie
    val category: String = "",          // Kategória (napr. "Potraviny", "Zábava")
    val type    : String = "expense",   // Typ: "expense" (výdavok) alebo "income" (príjem)
